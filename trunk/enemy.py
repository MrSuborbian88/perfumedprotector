...
class Enemy(DirectObject):
    ...
    def _setup_collisions(self):
        ...
        self._sight_ray_hi = CollisionSegment()
        self._sight_ray_hi.setPointA(0, -1, 1)
        self._sight_ray_hi.setPointB(0,-3 * settings.GLOBAL_SCALE, 10*settings.GLOBAL_SCALE)
        ...
        self._sight_ray_lo = CollisionSegment()
        self._sight_ray_lo.setPointA(0, -1, 1)
        self._sight_ray_lo.setPointB(0,-3 * settings.GLOBAL_SCALE, -10*settings.GLOBAL_SCALE)
