...
class Enemy(DirectObject):
    ...
    def _setup_collisions(self):
        ...
        self._sight_ray_hi.setOrigin(0, 0, 1)
        ...
        self._sight_ray_lo.setOrigin(0, 0, 1)
        ...
        self._sight_ray_mi.setOrigin(0, 0, 1)
        ...
        self._sight_ray_le.setOrigin(0, 0, 1)
        ...
        self._sight_ray_ri.setOrigin(0, 0, 1)
        ...
        self._player = CollisionSphere(0, 0, 0, 5)
    ...
    def _read_points(self,file_loc):
        ...
        for line in f:
            if line!="\n":
                #I'm assuming structure of wave, enemy, lane, frame to spawn
                string.replace(line,' ','')
                line_arr=line.split(',')
                for i in range(0, len(line_arr)):
                    line_arr[i]=int(line_arr[i])
                self._points.append(line_arr) #unloaded stores enemies until it is time for them to appear
